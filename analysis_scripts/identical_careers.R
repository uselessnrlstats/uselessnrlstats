##### Description #####
# An R script to look at players with identical career W/L/D records
...
player_match_data |>
  ...
  select(player_id, career_years, full_name, n_matches, record) |>
  count(n_matches, record) |>
  filter(n > 1) |>
