##### Description #####
# An R script to look at players with the most sin-bins per match (all-time)
...
final_table <- matches_per_bin |>
  ...
  prependContent(h5(class = "subtitle",
                    ...
                    "<b>Early Showers:</b> NSWRL/NRL Players with the fewest matches per sin bin or send off (all time). Minimum 3 SB + SO." |> HTML()))
final_table

saveWidget(final_table, "tables/html/matches_per_bin_all.html")
webshot(url = "tables/html/matches_per_bin_all.html", 
        file = "tables/png/matches_per_bin_all.png", 
