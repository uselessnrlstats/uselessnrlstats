...
left_side <- c("Q", "W", "E", "R", "T", "A", "S", "D", "F", "G", "Z", "X", "C", "V", "B")
right_side <- c("Y", "U", "I", "O", "P", "-", "H", "J", "K", "L", "'", "N", "M")
...
player_data |>
  ...
  mutate(n_letters = length(full_name_letters),
         first_name_side = all(first_name_letters %in% left_side) | all(first_name_letters %in% right_side),
         last_name_side = all(last_name_letters %in% left_side) | all(last_name_letters %in% right_side),
         full_name_side = all(full_name_letters %in% left_side) | all(full_name_letters %in% right_side)) |>
  filter(first_name_side & last_name_side) |>
