...
##### Analysis #####
over_10_conversions <- player_match_data |>
  ...
  arrange(desc(goals)) |>
  filter(goals == goal_attempts, goals >= 10) |>
...
final_table <- goalkicking_data |>
  ...
  prependContent(h5(class = "subtitle",
                    ...
                    "Nrl era (1998-) matches with the most goals kicked by both teams without a miss"))
final_table
