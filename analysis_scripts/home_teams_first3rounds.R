...
final_table <- home_team_wins |>
  ...
  prependContent(h4(class = "title", 
                    ...
                    "Home Team Record Rds1-3")) |>
  prependContent(h5(class = "subtitle",
                    style = "font-family: Roboto Regular; margin-left: 25px; display: flex; flex-direction: column",
                    "NRL Era (1998-2024) win rate of home <br> teams in the first three rounds" |> HTML()))
final_table

saveWidget(final_table, "tables/html/home_team_wins.html")
webshot(url = "tables/html/home_team_wins.html", 
        file = "tables/png/home_team_wins.png", 
